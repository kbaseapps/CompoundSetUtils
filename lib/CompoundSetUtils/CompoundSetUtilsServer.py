...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'CompoundSetUtils'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from CompoundSetUtils.CompoundSetUtilsImpl import CompoundSetUtils  # noqa @IgnorePep8
impl_CompoundSetUtils = CompoundSetUtils(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'CompoundSetUtils'
